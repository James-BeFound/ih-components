class IhLaneCoveClinicDetails extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>Everything You Need to Know About Our Lane Cove Clinic</h2>
      <div class="underline-accent"></div>
      <p class="intro-text">
          Full address, transport links, <strong>physiotherapy services available</strong>, and direct booking. Everything you need before your first visit.
        </p>
      <div class="acc-card">
      <div aria-controls="acc-body" aria-expanded="true" class="acc-header" id="acc-header" role="button">
      <div class="acc-badge">1</div>
      <div class="acc-meta">
      <h3>Lane Cove Physiotherapy Clinic</h3>
      <p class="acc-address">
      <svg class="pin-icon" viewbox="0 0 12 16"><path d="M6 0C3.24 0 1 2.24 1 5c0 3.75 5 11 5 11s5-7.25 5-11c0-2.76-2.24-5-5-5zm0 7a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"></path></svg>
                102-104 Longueville Road, Lane Cove NSW 2066  ·  Mon–Thu 8am–7pm, Fri 8am–6pm, Sat 8am–4pm
              </p>
      </div>
      ...
      <p>Suite 1.04, Level 1<br/>102-104 Longueville Road<br/>Lane Cove NSW 2066</p>
      <p style="font-size:11px;color:#aaa;margin-top:4px;">Newly renovated clinic</p>
      </div>
      ...
      <rect fill="#ff6218" height="11" opacity=".15" rx="2.5" width="14" x="2" y="3"></rect>
      <rect height="11" rx="2.5" stroke="#ff6218" stroke-width="1.3" width="14" x="2" y="3"></rect>
      <rect fill="#ff6218" height="4" opacity=".5" rx="1" width="8" x="5" y="6"></rect>
      <circle cx="5.5" cy="16" fill="#ff6218" r="1"></circle>
      <circle cx="12.5" cy="16" fill="#ff6218" r="1"></circle>
      <rect fill="#ff6218" height="1.5" opacity=".4" rx=".75" width="7" x="5.5" y="13"></rect>
      </svg>
      <p>
      <strong>Lane Cove Interchange</strong>
      <span>4-minute walk</span>
      </p>
      </div>
      <div class="transport-item">
      ...
      <p>
      <strong>Free Parking on Little Street</strong>
      <span>Next to Lane Cove Council</span>
      </p>
      </div>
      <p class="transport-note">
                  Up to 3 hours complimentary parking at The Canopy and Lane Cove Market Square, both a short walk from the clinic.
                </p>
      </div>
      ...
      <span class="tag">Deep Tissue Massage</span>
      <span class="tag">Exercise Rehab</span>
      <span class="tag">Manual Therapy</span>
      <span class="tag">Strengthening Programs</span>
      <span class="tag">Postural Correction</span>
      ...
      <button class="cta-btn">Book at Lane Cove →</button>
      </div>
      </div>
      </div>
      </div>
    ...
    shadow.querySelector('.cta-btn').addEventListener('click', () => {
      this.dispatchEvent(new CustomEvent('navigate', {
        detail: { url: 'https://app.halth.com/booking/org_2wfUwagaVRVTSC9Ax7BQav3hbSZ?location=130' },
        bubbles: true
      }));
    });
...
customElements.define('ih-lane-cove-clinic-details', IhLaneCoveClinicDetails);
