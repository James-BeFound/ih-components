class IhChiroServices extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <p class="subtitle">From physiotherapy and chiropractic to remedial massage, dry needling and shockwave therapy, our team delivers hands-on, evidence-based care across a wide range of services. Whether you are recovering from injury, managing a chronic condition or looking to perform at your best, we have the right treatment for you.</p>
...
customElements.define('ih-chiro-services', IhChiroServices);
