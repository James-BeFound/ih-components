class IhCbdClinicDetails extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>Everything You Need to Know About Our Sydney CBD Clinic</h2>
      <div class="underline-accent"></div>
      <p class="intro-text">
          Full address, transport links, team profiles, <strong>services available</strong>, and direct booking — everything you need before your first visit.
        </p>
      <div class="acc-card">
      ...
      <div class="acc-meta">
      <h3>Sydney CBD Physiotherapy Clinic</h3>
      <p class="acc-address">
      <svg class="pin-icon" viewbox="0 0 12 16"><path d="M6 0C3.24 0 1 2.24 1 5c0 3.75 5 11 5 11s5-7.25 5-11c0-2.76-2.24-5-5-5zm0 7a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"></path></svg>
                74 Pitt Street, Sydney NSW 2000  ·  Mon–Fri
              </p>
      </div>
      ...
      <p>Suite 103, Level 1<br/>74 Pitt Street<br/>Sydney NSW 2000</p>
      <p style="font-size:11px;color:#aaa;margin-top:4px;">In the building to the right of Mitre 10</p>
      </div>
      <div style="margin-bottom:14px;">
      <div class="hours-row"><span class="day">Mon – Thu</span><span class="time">8am – 6.30pm</span></div>
      <div class="hours-row"><span class="day">Friday</span><span class="time">8am – 6pm</span></div>
      <div class="hours-row"><span class="day">Saturday</span><span class="closed">Closed</span></div>
      ...
      <p>
      <strong>Wynyard Station</strong>
      <span>4-minute walk via Pitt Street</span>
      </p>
      </div>
      <div class="transport-item">
      <svg fill="none" viewbox="0 0 18 18">
      ...
      <p>
      <strong>Martin Place Station</strong>
      <span>3-minute walk</span>
      </p>
      </div>
      <p class="transport-note">
                  Public transport is the easiest way to reach us. We're right in the heart of the CBD on Pitt Street, served by multiple train lines and bus routes. No on-site parking — paid parking is available in surrounding streets.
                </p>
      </div>
...
customElements.define('ih-cbd-clinic-details', IhCbdClinicDetails);
