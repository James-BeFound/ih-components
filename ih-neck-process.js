class IhNeckProcess extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <div class="process-wrap">
        ...
        <h2>How We Treat Your Neck</h2>
        <div class="underline-accent"></div>
        <p class="intro-text">
          Every neck is different. Our evidence-based process is built to find the root cause of your pain and map a clear pathway back to full function.
        </p>
        ...
        <div class="steps-scroll-wrap" id="scrollWrap">
          <div class="steps-list">
            ...
            <div class="step-card">
              ...
              <div>
                <h3 class="step-title">Comprehensive Neck Assessment</h3>
...
customElements.define('ih-neck-process', IhNeckProcess);
