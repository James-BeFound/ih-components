class IhMosmanClinicDetails extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>Everything You Need to Know About Our Mosman Clinic</h2>
      <div class="underline-accent"></div>
      <p class="intro-text">
          Full address, parking options, <strong>physiotherapy services</strong>, and direct booking. Everything you need before your first visit.
        </p>
      <div class="acc-card">
      <div aria-controls="acc-body" aria-expanded="true" class="acc-header" id="acc-header" role="button">
      <div class="acc-badge">1</div>
      <div class="acc-meta">
      <h3>Mosman Physiotherapy Clinic</h3>
      <p class="acc-address">
      <svg class="pin-icon" viewbox="0 0 12 16"><path d="M6 0C3.24 0 1 2.24 1 5c0 3.75 5 11 5 11s5-7.25 5-11c0-2.76-2.24-5-5-5zm0 7a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"></path></svg>
                884 Military Road, Mosman NSW 2088  ·  Mon–Sat
              </p>
      </div>
      ...
      <p>Suite 2<br/>884 Military Road<br/>Mosman NSW 2088</p>
      </div>
      ...
      <div class="hours-row"><span class="day">Saturday</span><span class="time">8am – 3pm</span></div>
      ...
      <p>
      <strong>Military Road Street Parking</strong>
      <span>On-street parking directly outside</span>
      </p>
      </div>
      <div class="transport-item">
      ...
      <p>
      <strong>Raglan Street East Carpark</strong>
      <span>Additional parking directly behind the clinic</span>
      </p>
      </div>
      <p class="transport-note">
                  The clinic is located on Military Road with street parking available out front. The Raglan Street East Carpark sits directly behind the building for added convenience.
                </p>
      </div>
...
customElements.define('ih-mosman-clinic-details', IhMosmanClinicDetails);
