class IhChatswoodServices extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>Services at Our Chatswood Clinic</h2>
...
customElements.define('ih-chatswood-services', IhChatswoodServices);
