class IhStLeonardsServices extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>Services at Our St Leonards Clinic</h2>
        ...
        table.innerHTML = `
          <thead>
            <tr style="background:${cat.headerColor};">
              <th>Service</th>
              <th>Available at St Leonards</th>
            </tr>
          </thead>
        `;
...
customElements.define('ih-st-leonards-services', IhStLeonardsServices);
