class IhWomensHealthPhysiotherapyFaq extends HTMLElement {
  connectedCallback() {
    const shadow = this.attachShadow({ mode: 'open' });

    if (!document.getElementById('ih-womens-health-physiotherapy-faq-schema')) {
      const script = document.createElement('script');
      script.id = 'ih-womens-health-physiotherapy-faq-schema';
...
customElements.define('ih-womens-health-physiotherapy-faq', IhWomensHealthPhysiotherapyFaq);
