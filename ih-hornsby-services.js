class IhHornsbyServices extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>Services at Our Hornsby Clinic</h2>
...
customElements.define('ih-hornsby-services', IhHornsbyServices);
