class IhNorthSydneyServices extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      <style>
          ...
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          @media (min-width: 768px) {
            ...
            #categories-wrap { grid-template-columns: 1fr 1fr; gap: 28px; }
          }
      ...
      <h2>Services at Our North Sydney Clinic</h2>
    ...
    const CATEGORIES = [
        {
          ...
          services: [
            ...
            { name: 'Deep Tissue & Remedial Massage',      url: 'https://www.infinitehealthgroup.com.au/remedial-massage-therapy'             },
            ...
            { name: 'Postural Advice',                     url: PHYSIO                                                                         },
        ...
        },
        {
          ...
          services: [
            ...
            { name: 'Thompson Drop-Table Technique', url: CHIRO },
            { name: 'Diversified Adjustment',        url: CHIRO },
        ...
        table.innerHTML = `
          <thead>
            <tr style="background:${cat.headerColor};">
              <th>Service</th>
              <th>Available at North Sydney</th>
            </tr>
          </thead>
        `;
...
customElements.define('ih-north-sydney-services', IhNorthSydneyServices);
