class IhLaneCoveServices extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>Services at Our Lane Cove Clinic</h2>
...
customElements.define('ih-lane-cove-services', IhLaneCoveServices);
