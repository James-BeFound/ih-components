class IhHornsbyClinicDetails extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>Everything You Need to Know About Our Hornsby Clinic</h2>
      ...
      <div class="acc-meta">
      <h3>Hornsby Physiotherapy &amp; Chiropractic Clinic</h3>
      <p class="acc-address">
      <svg class="pin-icon" viewbox="0 0 12 16"><path d="M6 0C3.24 0 1 2.24 1 5c0 3.75 5 11 5 11s5-7.25 5-11c0-2.76-2.24-5-5-5zm0 7a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"></path></svg>
                284 Peats Ferry Road, Hornsby NSW 2077  ·  Mon–Sat
              </p>
      </div>
      ...
      <p>Suite 5<br/>284 Peats Ferry Road<br/>Hornsby NSW 2077</p>
      </div>
      <div style="margin-bottom:14px;">
      <div class="hours-row"><span class="day">Mon – Fri</span><span class="time">8am – 7pm</span></div>
      ...
      <p>
      <strong>Hornsby Train Station</strong>
      ...
      <p>
      <strong>Dural &amp; William Street Parking</strong>
      <span>Ample parking in the surrounding streets</span>
      </p>
      </div>
      <p class="transport-note">
                  Hornsby Train Station is a 3-minute walk from the clinic. Parking is available in the area between Dural Street and William Street.
                </p>
      </div>
      ...
      <span class="tag">Soft Tissue Release</span>
      <span class="tag">Joint Mobilisation</span>
...
customElements.define('ih-hornsby-clinic-details', IhHornsbyClinicDetails);
