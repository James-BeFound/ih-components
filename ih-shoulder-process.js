class IhShoulderProcess extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <div class="process-wrap">
        ...
        <h2>How We Treat Your Shoulder</h2>
        <div class="underline-accent"></div>
        <p class="intro-text">
          Every shoulder is different. Our evidence-based process is built to find the root cause of your pain and map a clear pathway back to full function.
        </p>
        ...
        <div class="steps-scroll-wrap" id="scrollWrap">
          <div class="steps-list">
            ...
            <div class="step-card">
              ...
              <div>
                <h3 class="step-title">Comprehensive Shoulder Assessment</h3>
            ...
            <div class="step-card">
              ...
              <div>
                ...
                <p class="step-body">We build an evidence-based plan tailored to your diagnosis and goals, combining manual therapy, shockwave, dry needling, and rehab in the right sequence.</p>
              </div>
            </div>
...
customElements.define('ih-shoulder-process', IhShoulderProcess);
