class IhChatswoodClinicDetails extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>Everything You Need to Know About Our Chatswood Clinic</h2>
      ...
      <div class="acc-meta">
      <h3>Chatswood Physiotherapy &amp; Chiropractic Clinic</h3>
      <p class="acc-address">
      <svg class="pin-icon" viewbox="0 0 12 16"><path d="M6 0C3.24 0 1 2.24 1 5c0 3.75 5 11 5 11s5-7.25 5-11c0-2.76-2.24-5-5-5zm0 7a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"></path></svg>
                71-73 Archer Street, Chatswood NSW 2067  ·  Mon–Sat
              </p>
      </div>
      ...
      <p>Suite 201, Level 2<br/>71-73 Archer Street<br/>Chatswood NSW 2067</p>
      </div>
      ...
      <p>
      <strong>Chatswood Train Station</strong>
      <span>7-minute walk</span>
      </p>
      </div>
      <div class="transport-item">
      <svg fill="none" viewbox="0 0 18 18">
      ...
      <p>
      <strong>Westfield &amp; Chase Carpark</strong>
      <span>3-minute walk, free parking</span>
      </p>
      </div>
      <p class="transport-note">
                  Chatswood is well served by train and metro. Free parking at Westfield Chatswood and the Chase Carpark makes the clinic easy to reach by car as well.
                </p>
      </div>
      ...
      <span class="tag">Sports Massage</span>
      <span class="tag">Shockwave Therapy</span>
      <span class="tag">Cupping</span>
      <span class="tag">Exercise Physiology</span>
...
customElements.define('ih-chatswood-clinic-details', IhChatswoodClinicDetails);
