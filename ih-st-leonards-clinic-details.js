class IhStLeonardsClinicDetails extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      <style>
          ...
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .pin-icon { flex-shrink: 0; width: 11px; height: 11px; fill: #ff6218; }
          ...
          .acc-divider { height: 1px; background: #eeece8; margin: 0 24px; }
          ...
          .acc-body.collapsed { max-height: 0; opacity: 0; }

          .acc-cols {
            display: grid; grid-template-columns: 1fr 1fr 1fr;
            gap: 0; padding: 28px 24px 32px;
          }
          ...
          .acc-col:last-child {
            border-right: none; padding-right: 0; padding-left: 24px;
          ...
          .addr-block p { font-size: 13px; color: #2d2d2d; line-height: 1.7; }
          ...
          .transport-item p { font-size: 13px; color: #2d2d2d; line-height: 1.6; }
          ...
          .services-tags { display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 14px; }
          ...
          @media (max-width: 767px) {
            ...
            .acc-cols {
              grid-template-columns: 1fr; gap: 28px; padding: 24px 20px 28px;
            }

            .acc-col {
              padding: 0 !important; border-right: none;
              border-bottom: 1px solid #eeece8; padding-bottom: 24px !important;
            }

            .acc-col:last-child { border-bottom: none; padding-bottom: 0 !important; }
      ...
      <h2>Everything You Need to Know About Our St Leonards Clinic</h2>
      <div class="underline-accent"></div>
      <p class="intro-text">
          Full address, transport links, <strong>physiotherapy services</strong>, and direct booking. Everything you need before your first visit.
        </p>
      <div class="acc-card">
      <div aria-controls="acc-body" aria-expanded="true" class="acc-header" id="acc-header" role="button">
      <div class="acc-badge">1</div>
      <div class="acc-meta">
      <h3>St Leonards Physiotherapy Clinic</h3>
      <p class="acc-address">
      <svg class="pin-icon" viewbox="0 0 12 16"><path d="M6 0C3.24 0 1 2.24 1 5c0 3.75 5 11 5 11s5-7.25 5-11c0-2.76-2.24-5-5-5zm0 7a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"></path></svg>
                69 Christie Street, St Leonards NSW 2065  ·  Mon–Sat (Suite 304, Level 3)
              </p>
      </div>
      ...
      <p>Suite 304, Level 3<br/>69 Christie Street<br/>St Leonards NSW 2065</p>
      </div>
      ...
      <div class="hours-row"><span class="day">Saturday</span><span class="time">8am – 4pm</span></div>
      ...
      <p>
      <strong>St Leonards Train Station</strong>
      <span>Short walk, North Shore Line</span>
      </p>
      </div>
      <div class="transport-item">
      <svg fill="none" viewbox="0 0 18 18">
      ...
      <p>
      <strong>Crows Nest Metro Station</strong>
      <span>Short walk via the Metro network</span>
      </p>
      </div>
      <div class="transport-item">
      <svg fill="none" viewbox="0 0 18 18">
      <rect fill="#ff6218" height="14" opacity=".15" rx="3" width="14" x="2" y="2"></rect>
      <rect height="14" rx="3" stroke="#ff6218" stroke-width="1.3" width="14" x="2" y="2"></rect>
      <path d="M7 13V5h3a2.5 2.5 0 0 1 0 5H7" stroke="#ff6218" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path>
      </svg>
      <p>
      <strong>Mall 88 — Free 2-Hour Parking</strong>
      <span>4-minute walk from the clinic</span>
      </p>
      </div>
      <p class="transport-note">
                  St Leonards Train Station and Crows Nest Metro are both a short walk away. Free 2-hour parking is available at Mall 88, a 4-minute walk from the clinic.
                </p>
      </div>
      ...
      <span class="tag">Shockwave Therapy</span>
      <span class="tag">WorkCover</span>
      <span class="tag">NDIS</span>
      <span class="tag">Telehealth</span>
      </div>
      <p class="booking-note">
                  No referral required. All major health funds accepted via HICAPS. Medicare available with a GP referral. Same-day and next-day appointments often available.
                </p>
...
customElements.define('ih-st-leonards-clinic-details', IhStLeonardsClinicDetails);
