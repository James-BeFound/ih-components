class IhBackProcess extends HTMLElement {
  connectedCallback() {
    ...
    shadow.innerHTML = `
      ...
      <h2>How We Treat Your Back</h2>
      <div class="underline-accent"></div>
      <p class="intro-text">
          Every back is different. Our evidence-based process is built to find the root cause of your pain and map a clear pathway back to full function.
        </p>
      ...
      <div>
      <h3 class="step-title">Comprehensive Back Assessment</h3>
      ...
      <p class="step-body">We build an evidence-based plan tailored to your diagnosis and goals, combining manual therapy, shockwave, dry needling, and exercise rehab in the right sequence.</p>
      </div>
      </div>
      <div class="step-card">
      ...
      <p class="step-body">One-on-one sessions combining manual therapy, joint mobilisation, soft tissue release, and targeted exercise to restore movement and reduce back pain.</p>
      </div>
      </div>
      <div class="step-card">
...
customElements.define('ih-back-process', IhBackProcess);
