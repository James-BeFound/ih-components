class IhBackFaq extends HTMLElement {
  connectedCallback() {
    const shadow = this.attachShadow({ mode: 'open' });

    if (!document.getElementById('ih-back-faq-schema')) {
      const script = document.createElement('script');
      script.id = 'ih-back-faq-schema';
    ...
    shadow.innerHTML = `
      ...
      <h2>Back Physio FAQ</h2>
      <div class="underline-accent"></div>
      <p class="intro-text">Everything you need to know before your first back physiotherapy appointment.</p>
      ...
      <span class="faq-question">What is the difference between a chiropractor and a physiotherapist for back pain?</span>
      <span class="faq-icon">
      ...
      <p class="faq-answer">Both can help with back pain but through different approaches. Chiropractors focus primarily on spinal manipulation and adjustments to address joint dysfunction. Physiotherapists take a broader clinical approach, combining manual therapy, exercise rehabilitation, dry needling, shockwave therapy, and patient education to address the underlying cause of pain and build long-term resilience. At Infinite Health, we offer both chiropractic and physiotherapy, and our practitioners often work together to give you the most comprehensive care.</p>
      </div>
      </li>
      <li class="faq-item">
      <button aria-expanded="false" class="faq-trigger">
      <span class="faq-question">What does a physiotherapist do?</span>
      <span class="faq-icon">
      <svg class="icon-plus" fill="none" viewbox="0 0 14 14"><path d="M7 1v12M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      <svg class="icon-minus" fill="none" viewbox="0 0 14 14"><path d="M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      </span>
      ...
      <div class="faq-panel" role="region">
      <p class="faq-answer">Physiotherapists are university-trained allied health professionals who assess, diagnose, and treat conditions affecting movement and function. In a back pain context, your physio will take a detailed history, perform a physical assessment to identify the cause of your pain, and design a personalised treatment plan. This typically includes hands-on therapy, targeted exercises, and education on how to manage and prevent your condition long term.</p>
      </div>
      </li>
      <li class="faq-item">
      <button aria-expanded="false" class="faq-trigger">
      <span class="faq-question">When should I see a physio for back pain?</span>
      <span class="faq-icon">
      <svg class="icon-plus" fill="none" viewbox="0 0 14 14"><path d="M7 1v12M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      <svg class="icon-minus" fill="none" viewbox="0 0 14 14"><path d="M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      </span>
      ...
      <div class="faq-panel" role="region">
      <p class="faq-answer">You should see a physio if your back pain has lasted more than a few days without improvement, is affecting your ability to work or move, or is accompanied by nerve symptoms such as pain, numbness, or tingling in the legs. Seek urgent assessment if you experience sudden severe pain following an injury, weakness in your legs, or any changes to bladder or bowel function, as these may indicate a more serious condition requiring immediate attention.</p>
      </div>
      </li>
      <li class="faq-item">
      <button aria-expanded="false" class="faq-trigger">
      <span class="faq-question">Does physio help sciatica?</span>
      <span class="faq-icon">
      <svg class="icon-plus" fill="none" viewbox="0 0 14 14"><path d="M7 1v12M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      <svg class="icon-minus" fill="none" viewbox="0 0 14 14"><path d="M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      </span>
      ...
      <div class="faq-panel" role="region">
      <p class="faq-answer">Yes, physiotherapy is one of the most effective treatments for sciatica. Most cases are caused by a disc pressing on the sciatic nerve, and research consistently shows that targeted physio can reduce nerve irritation, restore movement, and resolve symptoms without surgery. Treatment typically includes nerve mobilisation techniques, joint mobilisation, manual therapy, and a progressive strengthening program to reduce load on the affected disc.</p>
      </div>
      </li>
      <li class="faq-item">
      <button aria-expanded="false" class="faq-trigger">
      <span class="faq-question">What does a physio do for back pain?</span>
      <span class="faq-icon">
      <svg class="icon-plus" fill="none" viewbox="0 0 14 14"><path d="M7 1v12M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      <svg class="icon-minus" fill="none" viewbox="0 0 14 14"><path d="M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      </span>
      ...
      <div class="faq-panel" role="region">
      <p class="faq-answer">For back pain specifically, your physio begins with a thorough assessment to identify the exact structure at fault, whether that is a muscle, disc, joint, or nerve. Treatment is then tailored to your diagnosis and typically includes manual therapy to restore joint movement, soft tissue release and dry needling to address muscle tension and spasm, shockwave therapy where disc or tendon pathology is involved, and a personalised exercise program to rebuild strength and stability in the spine.</p>
      </div>
      </li>
      <li class="faq-item">
      <button aria-expanded="false" class="faq-trigger">
      <span class="faq-question">Should I see a physio for back pain?</span>
      <span class="faq-icon">
      <svg class="icon-plus" fill="none" viewbox="0 0 14 14"><path d="M7 1v12M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      <svg class="icon-minus" fill="none" viewbox="0 0 14 14"><path d="M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      </span>
      ...
      <div class="faq-panel" role="region">
      <p class="faq-answer">In most cases, yes. Physiotherapy is the recommended first-line treatment for back pain by both the Australian Physiotherapy Association and international clinical guidelines. Seeing a physio early, rather than waiting it out or relying solely on pain medication, significantly improves recovery outcomes and reduces the risk of back pain becoming chronic. Most acute back injuries that receive proper physio care resolve within weeks rather than months.</p>
      </div>
      </li>
      <li class="faq-item">
      <button aria-expanded="false" class="faq-trigger">
      <span class="faq-question">Does physiotherapy help back pain?</span>
      <span class="faq-icon">
      <svg class="icon-plus" fill="none" viewbox="0 0 14 14"><path d="M7 1v12M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      <svg class="icon-minus" fill="none" viewbox="0 0 14 14"><path d="M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      </span>
      ...
      <div class="faq-panel" role="region">
      <p class="faq-answer">Yes, and the evidence is strong. Multiple systematic reviews and clinical guidelines confirm that physiotherapy is one of the most effective treatments for acute, subacute, and chronic lower back pain. A combination of manual therapy and targeted exercise rehabilitation consistently outperforms rest or pain medication alone. The key is identifying the right treatment approach for your specific diagnosis, which is why a thorough assessment always comes first.</p>
      </div>
      </li>
      <li class="faq-item">
      <button aria-expanded="false" class="faq-trigger">
      <span class="faq-question">How many physio sessions will I need for back pain?</span>
      <span class="faq-icon">
      <svg class="icon-plus" fill="none" viewbox="0 0 14 14"><path d="M7 1v12M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      <svg class="icon-minus" fill="none" viewbox="0 0 14 14"><path d="M1 7h12" stroke="#ff6218" stroke-linecap="round" stroke-width="2"></path></svg>
      </span>
      ...
      <div class="faq-panel" role="region">
      <p class="faq-answer">It depends on your diagnosis and how long you have had the pain. Acute muscle strains may resolve in 4 to 6 sessions over 2 to 4 weeks. Disc-related injuries or sciatica typically require 8 to 12 sessions over 6 to 12 weeks. Chronic or complex back pain may need a longer program. Your physiotherapist will give you a realistic session estimate at your initial assessment and adjust the plan based on how you respond to treatment.</p>
      </div>
      </li>
      </ul>
      </div>
...
customElements.define('ih-back-faq', IhBackFaq);
